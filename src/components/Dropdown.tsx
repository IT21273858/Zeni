...
export default function NestedList() {
    ...
    return (
        <List
            sx={{ width: '100%', maxWidth: 1200, bgcolor: 'background.paper', borderRadius: 5, marginTop: 2 }}
            component="nav"
            aria-labelledby="nested-list-subheader"
            subheader={
                <ListSubheader component="div" id="nested-list-subheader"
                    sx={{ width: '100%', maxWidth: 1200, borderTopRightRadius: 10, borderTopLeftRadius: 10 }}
                >
                    Resources
                </ListSubheader>
            }
